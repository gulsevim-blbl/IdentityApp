...
{
    [HtmlTargetElement("td", Attributes = "asp-role-users")] //Hangi HTML elementi üzerinde çalışacağını belirtiyoruz. ilke td elementi üzerinde çalışacak. ikinci attribute ismi.
